...
public class FileUtils 
{
	...
	public static String EkkoAppCachePath(){
		String path =  Environment.getExternalStorageDirectory().getAbsolutePath()+"/ekko/cache/";
	...
	public static String EkkoZippedCoursesPath(){
		String path =  FileUtils.EkkoFilePath() + "courses/downloads/";
	...
	public static String EkkoCourseSetRootPath(){
		String path =  FileUtils.EkkoFilePath() + "courses/";
	...
	public static File generateFileFromInputStream(String fileName, InputStream inputStream) {
		...
		try	{	
			...
			Log.e("FileUtil-GenerateFileFromInputStream", e.toString());
